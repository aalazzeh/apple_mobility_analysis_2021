...
# when knitting keeping the echo and message to TRUE allows you to see the code, messages, and troubleshooting messages that helps you while developing the code that you. If you changed the echo and 
# message to FALSE then it would produce a clean and well formatted 
# document without the extra notes
...
```{r tallied-subset}
# tally up the number of cities and counties in the state that have mobility # data available
